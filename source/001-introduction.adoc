...
* *Sideband* -- Messaging App
** Peer -- Send and receive messages (LXMF client)
* *Nomad Network* -- Mesh communication platform
** *Peer* -- Send and receive messages (LXMF client)
** *Node* -- Propagate and store messages
** *Node* -- Host pages and files
...
** RNode Firmware -- C Implementation
* *Host Device*
